...
Documentation is generated by consuming a **sanitized runtime bundle** from the private `octo` repo, running that data through deterministic renderers / an LLM API, and writing polished Markdown pages.
...
- entries marked external stay in the overview page but link out to the plugin's own repo
