...
| 🗄️ | [Config Backup](plugins/config-backup) | Backs up OpenClaw config to Git with SHA-256 change detection | 1 | [Read docs](plugins/config-backup) |
...
| 🐙 | [GitHub](plugins/github) | Manage GitHub issues. Create, read, update, close, comment on, and list issues. | 6 | [Read docs](plugins/github) |
