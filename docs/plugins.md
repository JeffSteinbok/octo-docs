...
|---|--------|-------------|:-----:|
| 🗄️ | [Config Backup](plugins/config-backup) | Backs up OpenClaw config to Git with SHA-256 change detection. Ensures that configuration and agent workspace files are committed and pushed only when content changes. | 1 |
...
| 🍽️ | [Weightwatchers](plugins/weightwatchers) | Search foods, log meals, view your diary, and manage your points budget via the unofficial Weightwatchers (WW) API. | 7 |
