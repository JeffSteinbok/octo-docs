...
| 🍽️ | [restaurant-cli](https://github.com/omarshahine/restaurant-cli) | Pluggable reservation booking via Resy, OpenTable, Tock, and other providers | [Read docs](https://github.com/omarshahine/restaurant-cli) |
