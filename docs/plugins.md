...
| 📷   | [Hass Camera Snapshot](#📷-hass-camera-snapshot) | Take snapshots from Home Assistant cameras via hass-cli and save locally | 2 |
...
| 🎵   | [Spotify](#🎵-spotify) | Control Spotify playback, search music, and manage playlists | 0 |
| 🍎   | [Weight Watchers](#🍎-weight-watchers) | Search foods, log meals, view diary and points budget via the unofficial WW API | 5 |
