...
| 🏠    | [Home Assistant CLI](#homeassistant-cli)                                    | Control Home Assistant via hass-cli: get/list entity states, call services, and list events    | 4          |
...
| Name       | Type    | Description                          |
|------------|---------|--------------------------------------|
| account_id | string  | JMAP account ID                     |
...
| duration   | string  | Duration (default: 1h)              |
...
| Name        | Type    | Description                                                                 |
|-------------|---------|-----------------------------------------------------------------------------|
| camera_name | string  | Name of the camera to snapshot. One of: living-room, front-doorbell, etc.   |
...
| Name      | Type    | Description                                   |
|-----------|---------|-----------------------------------------------|
| domain    | string  | Service domain (e.g. light, switch, scene)    |
