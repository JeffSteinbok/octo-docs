...
Search foods, log meals, view your diary, and manage your points budget via the unofficial Weightwatchers API.
...
| date         | string  | Date in YYYY-MM-DD format (default: today)                          |
| meal_type    | string  | Meal slot to log to (default: snacks): breakfast, lunch, dinner, snacks |
